...
const announcesTitles = [
  ...
  },
  {
    ...
    'description': 'Смотрите фильмы и сериалы на телефоне, планшете, ноутбуке и телевизоре без ограничений и без дополнительной платы.',
  ...
  },
  {
    ...
    'description': 'Подарите детям мир приключений с их любимыми героями. Он создан специально для них и уже доступен с вашей подпиской.',
...
const announceLoadAnimationImg = {
  ...
  'altDescr': 'pre-load example',
};

const announceLoadAnimationTexts = [
  'Очень странные дела',
  'Идет загрузка...'
];
...
export {
  announcesVideos,
  announcesTitles,
  announceLoadAnimationImg,
  announceLoadAnimationTexts,
}
